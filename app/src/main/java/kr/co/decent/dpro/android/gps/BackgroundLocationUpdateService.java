package kr.co.decent.dpro.android.gps;
...
import kr.co.decent.dpro.android.MainActivity;
...
public class BackgroundLocationUpdateService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private void StartForeground() {
        ...
        builder.setContentTitle(CommonConstants.PROJECT_NAME + "");
        builder.setContentText(CommonConstants.PROJECT_NAME + "에서 위치정보를 사용하고 있습니다.");
